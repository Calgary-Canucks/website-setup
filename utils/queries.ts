export const dynamicsPageSectionsQuery =
  "$select=bsi_name,bsi_pagesectionid,bsi_videourl,bsi_paragraph,bsi_ctabuttonlink,bsi_ctabuttontext,bsi_youtubevideoid,_bsi_designedsection_value,bsi_youtubevideoalttext,bsi_hasctabutton,bsi_mainheading,bsi_subheading,bsi_sectionid,bsi_featuredproducts,bsi_backgroundcolor,bsi_mainheadingtextcolor,bsi_subheadingtextcolor,bsi_paragraphtextcolor,bsi_ctabuttontextcolor,bsi_ctabuttonbgcolor&$orderby=bsi_sequence asc&$expand=bsi_AttachedComponent_bsi_PageSection_bsi($select=bsi_attachedcomponentid,bsi_name,bsi_description,bsi_descriptiontextcolor,bsi_hasctabutton,bsi_ctabuttontext,bsi_ctabuttontextcolor,bsi_ctabuttonbgcolor,bsi_ctabuttonlink,bsi_title,bsi_titletextcolor,bsi_subtitle,bsi_subtitletextcolor,bsi_backgroundcolor),bsi_PageSection_bsi_ImageAsset_bsi_ImageA($select=bsi_cdnurl,bsi_alttext),bsi_DesignedSection($select=bsi_name),bsi_Background($select=bsi_cdnurl)";
...
export const dynamicsMatchesQuery =
  "$select=bsi_name,bsi_teamonescore,bsi_teamtwoscore,bsi_matchtime&$expand=bsi_TeamOne($select=bsi_name),bsi_TeamTwo($select=bsi_name),bsi_Venue($select=bsi_name,bsi_addressline1)";
